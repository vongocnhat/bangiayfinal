		<div class="img-slider">
			...
			<ul id="jquery-demo">
			  <li>
			    <a href="#slide1">
			      <img src="admin_assets/productimages/slide-1.jpg" alt="" />
			    </a>
			  ...
			  <li>
			    <a href="#slide2">
			      <img src="admin_assets/productimages/slide-2.jpg"  alt="" />
			    </a>
			     <div class="slider-detils">
			    	<h3>MENS FOOT BALL <label>BOOTS</label></h3>
			    	<span>Stay true to your team all day, every day, game day.</span>
			  ...
			  <li>
			    <a href="#slide3">
			      <img src="admin_assets/productimages/slide-3.jpg" alt="" />
			    </a>
			     <div class="slider-detils">
			    	<h3>MENS FOOT BALL <label>BOOTS</label></h3>
			    	<span>Stay true to your team all day, every day, game day.</span>
